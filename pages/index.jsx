        ...
        <MainLayout title='Главная'>
            <div className="content">
                <div className="welcome-text">
                    <h2 className="welcome-title">Производство пластиковых, алюминиевых и деревянных окон в Санкт-Петербурге</h2>
                    <div className="welcome-par">“Центр Промышленных Инноваций - СПб” приветствует Вас</div>
                </div>
                <div className="welcome-win">
                    <div className="welcome-win-card">
                        <img className="welcome-win-card-img" src="/static/dev_logo.png" alt="dev logo" />
                        <div className="welcome-win-card-text">Пластиковые окна</div>
                    </div>
                    <div className="welcome-win-card">
                        <img className="welcome-win-card-img" src="/static/dev_logo.png" alt="dev logo" />
                        <div className="welcome-win-card-text">Алюминиевые окна</div>
                    </div>
                    <div className="welcome-win-card">
                        <img className="welcome-win-card-img" src="/static/dev_logo.png" alt="dev logo" />
                        <div className="welcome-win-card-text">Деревянные окна</div>
                    </div>
                    <div className="welcome-win-card">
                        <img className="welcome-win-card-img" src="/static/dev_logo.png" alt="dev logo" />
                        <div className="welcome-win-card-text">Дерево-алюминиевые окна</div>
                    </div>
                </div>
            </div>
            {/* <div className="content"> */}
            ...
            <div className="content">
                ...
                <Link href="/">
                    <div className="category big">
                        <img src="/static/dev_logo.png" alt="Подоконники" className="category-img" />
                        <div className="category-name">Стеклопакеты</div>
                    </div>
                </Link>
                <Link href="/wos">
                    <div className="category big">
                        <img src="/static/categories/wos.jpg" alt="Подоконники" className="category-img" />
                        <div className="category-name">Системы открывания окон</div>
                    </div>
                </Link>
                <Link href="/drainages">
                    <div className="category min">
                        <img src="/static/categories/drainages.jpg" alt="Подоконники" className="category-img" />
                        <div className="category-name">Водоотливы</div>
                    </div>
                </Link>
                <Link href="/slopes">
                    <div className="category min">
                        <img src="/static/categories/slopes.jpg" alt="Подоконники" className="category-img" />
                        <div className="category-name">Откосы</div>
                    </div>
                </Link>
                <Link href="/mosqnets">
                    <div className="category min">
                        <img src="/static/categories/mosqnets.png" alt="Подоконники" className="category-img" />
                        <div className="category-name">Москитные сетки</div>
                    </div>
                </Link>
                <Link href="/fittings">
                    <div className="category min">
                        <img src="/static/categories/fittings.jpg" alt="Подоконники" className="category-img" />
